      ...
      <Header style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
          ...
          <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
            <a href="#/" style={{ color: 'rgba(255,255,255,0.7)', fontSize: '14px' }}>Hỗ sơ chỉ duyệt</a>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          <Input 
            ...
            placeholder="Tìm kiếm hồ sơ, thửa đất..." 
            variant="filled"
          ...
          <div style={{ padding: '24px 0', flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ padding: '0 24px', display: 'flex', alignItems: 'center', marginBottom: '32px' }}>
              ...
              <div style={{ marginLeft: '12px' }}>
                ...
                <div style={{ fontSize: '10px', color: '#8c8c8c', textTransform: 'uppercase', letterSpacing: '0.5px' }}>QUẢN LÝ ĐỊA CHÍNH</div>
              </div>
            </div>
            ...
            <Menu 
              ...
              items={[
                ...
                { type: 'divider', style: { margin: '8px 0', backgroundColor: 'transparent' } },
                { key: '/officer/map', icon: <EnvironmentOutlined />, label: 'Bản đồ địa chính' }
              ]}
            />
          </div>
